...
export const SocketProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    if (!globalSocket) {
      ...
      globalSocket = io((process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3005'), {
        path: '/socket.io',
    ...
    if (!globalMediaSocket) {
      const mediaSocketUrl = process.env.NEXT_PUBLIC_MEDIA_URL || (process.env.NEXT_PUBLIC_CALL_API_URL || 'http://localhost:4000');
