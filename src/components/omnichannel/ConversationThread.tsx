  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (activeConv.channel === 'email') {
        await fetch(`https://crm-files.onrender.com/api/messages/send-email`, {
          method: 'POST',
        ...
        await fetch(`https://crm-files.onrender.com/api/messages/send-whatsapp`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            conversationId: activeConv.id,
        ...
        await fetch(`https://crm-files.onrender.com/api/messages/send-instagram`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            conversationId: activeConv.id,
        ...
        await fetch(`https://crm-files.onrender.com/api/v1/messages/send`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            conversationId: activeConv.id,
